...
AHORA HAREMOS USO DE LA FUNCION MAP, QUE itera sobre los elementos de un array
y devuelve un nuevo array con las modificaciones pedidas mediante una funcion
***/
...
//Funcion para pasar la altura de las personas a centimetros
...
//Para no pisar el objeto original, modificamos y creamos un nuevo objeto
const  pasarAlturaCms = persona =>({
   ...persona,
   altura: persona.altura *100
});

//=>la notacion ({}) es retorno de un objeto en la funcion arrow
var personasCms = personas.map(pasarAlturaCms);

// console.log(personasAltas);
// console.log(personaBajas);

console.log(personasCms);//=> descubrimos despues que cambia el arreglo original
